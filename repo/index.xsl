...
<div id="pwmaster" style="width:500px;clear:both;display:none;">
   <br/><br/><br/><br/><br/>	
   &#8201;&#8201;&#8201;&#8201;&#8201;&#8201;&#8201;&#8201;Please login:&#8201;&#8201;&#8201;<input id="password" type="password" style="width:300px;padding:8px;border-radius:4px;background:lightyellow;" placeholder="password"/>&#8201;&#8201;<input type="submit" value="Send" style="height:46px;background:red;color:#FFFFFF;font-weight:900;" onclick="checkpw($('#password').val())"/>
</div>
...
<span style="font-style:italic;font-size:11px"><xsl:value-of select="DATE"/></span><br/>
 ...
 <div id="friends" style="background:rgb(233, 238, 248);">    
  ...
  <div id="footer" style="width:100%;text-align:right;">
    <span style="background:#FFFFFF; opacity:0.7;">&#8201;&#8201;get <a href="http://github.com/dtmf7133/ExtranetLo" style="color:#d2524c;font-weight:900;">ExtranetLo</a>. A <a href="https://numode.eu" style="color:#d2524c;font-weight:900;">NuMode</a> project.</span>&#8201;&#8201;
  </div>
